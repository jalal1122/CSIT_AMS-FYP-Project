  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-sky-50 via-white to-slate-50 flex items-center justify-center p-2.5 sm:p-4 relative overflow-hidden">
      ...
      <div className="card w-full max-w-md p-4 sm:p-8 md:p-10 relative z-10 shadow-xl shadow-sky-100/50 border border-slate-100">
        ...
        <Link to="/login" className="inline-flex items-center gap-2 text-xs sm:text-sm text-sky-600 hover:text-sky-700 font-semibold mb-6 sm:mb-8 transition-colors">
          <ArrowLeft className="w-4 h-4" /> Back to Login
        </Link>

        <div className="mb-6 sm:mb-8">
          <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-800 tracking-tight mb-1 sm:mb-2">Reset Password</h2>
          <p className="text-xs sm:text-sm text-slate-500 font-medium">Enter your email to receive reset instructions</p>
        </div>
        ...
        {message ? (
          <div className="mb-6 p-4 sm:p-6 bg-emerald-50 border border-emerald-200 rounded-xl text-emerald-700 text-center flex flex-col items-center gap-3 shadow-sm">
