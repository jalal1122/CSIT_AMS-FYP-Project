      ...
      <main className="max-w-3xl mx-auto p-3 sm:p-4 md:p-8 space-y-4 sm:space-y-6 w-full">
        <div className="flex items-center justify-between gap-2 sm:gap-4">
          <div className="flex items-center gap-2 sm:gap-4 min-w-0">
            <Link to={`/admin/dashboard`} className="text-slate-400 hover:text-slate-600 transition-colors p-1.5 sm:p-2 hover:bg-slate-100 rounded-lg bg-white border border-slate-200 shadow-sm shrink-0">
              <ArrowLeft className="w-4 h-4 sm:w-5 sm:h-5" />
            </Link>
            <h1 className="text-xl sm:text-2xl font-bold text-slate-800 tracking-tight truncate">Admin Profile</h1>
          </div>
          {!isEditing && (
        ...
        <div className="card p-3.5 sm:p-6 md:p-8 shadow-sm">
          ...
          {isEditing ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
              ...
              <div className="min-w-0">
                <p className="text-xs sm:text-sm font-semibold text-slate-400 mb-0.5">Username</p>
