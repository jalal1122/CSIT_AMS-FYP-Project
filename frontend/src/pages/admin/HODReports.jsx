  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h2 className="text-2xl font-bold text-slate-800">Academic Leadership Reports</h2>
          <p className="text-slate-500 text-sm mt-1">Department-wide attendance trends, exam eligibility, and defaulters.</p>
        </div>
      </div>
        ...
        <div className="flex-1 space-y-6">
          {!hasSearched ? (
            <EmptyState 
              ...
              message="Select your criteria from the sidebar to dynamically construct a report for your department."
            />
          ) : isReportLoading ? (
            ...
            <>
              ...
              <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
                ...
                {/* At-Risk Radar / Exam Eligibility */}
                <div className="card bg-white p-5 border-slate-200">
                  <h3 className="font-bold text-slate-800 mb-4 flex items-center gap-2">
                    <AlertTriangle className="w-4 h-4 text-red-500" /> Exam Eligibility Warnings (&lt; 75%)
                  </h3>
                ...
                <div className="card bg-white p-5 border-slate-200">
                  <h3 className="font-bold text-slate-800 mb-4 flex items-center gap-2">
                    <BookOpen className="w-4 h-4 text-sky-500" /> Department Distribution (Top 20)
                  </h3>
                  {students.length === 0 ? (
                    <div className="text-center py-10 text-slate-500 text-sm">
